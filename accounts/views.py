...
from .filters import OrderFilter #for the filter functionality
...
def customer(request, pk):
    ...
    #filter works by getting the data and then filtering it based on the GET request and then displays it.
